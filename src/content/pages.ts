...
export const newPatients = {
  ...
  expect:
    "We will review your health history, take any X-rays we need, and complete a full exam. Before you leave, the doctor will walk you through what he found and what he recommends, in plain language and with clear prices. No surprises and no pressure.",
  bringHeading: "What to bring",
  bring: [
    "A photo ID",
    "Your dental insurance card, if you have one",
    "A list of any medications you take",
    "Recent X-rays or records from a previous dentist, if available",
  ...
  plans: [
    {
      ...
      badge: "PPO",
      name: "PPO Plans",
      text: "We are a preferred provider for most PPO plans. That means your insurance company has already agreed on rates with our office, so your out of pocket costs stay predictable.",
    },
    {
      id: "hmo",
      badge: "HMO",
  ...
  payment: [
    {
      ...
      text: "We accept cash, personal checks, and all major credit cards. You will always know the price before treatment starts.",
    },
    {
      id: "carecredit",
      badge: "CareCredit",
      name: "CareCredit Financing",
      text: "CareCredit lets qualified patients split treatment into no interest monthly payments. Applying takes a few minutes, and approval is often instant.",
    },
    {
      id: "in-house",
      badge: "0% In House",
      name: "In House Financing",
      text: "We also offer a limited zero percent financing option for select patients. A deposit is required, and our office manager can tell you whether your treatment qualifies.",
    },
  ],
  promiseHeading: "Our promise on price",
  promise:
    "We cut the costs of luxury amenities that do not support patient care, and we pass those savings on to you. You come here for healthy teeth, not a fancy lobby.",
};
